      ...
      {step === "auth" && (
        <div className="space-y-5">
          <div className="text-sm text-zinc-300 leading-relaxed">
            Migrate your Railway stack to your self-hosted Northship control plane. App variables and command overrides are imported, while database engines are recreated with fresh Northship-managed credentials.
          </div>
