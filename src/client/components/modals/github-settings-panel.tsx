            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-relaxed text-zinc-400">
                  Configure the GitHub credentials Northship uses to browse repositories, read branches, and receive deployment webhooks.
                </p>
              </div>
            </div>
        ...
        <form onSubmit={saveSettings} className="space-y-5 border border-zinc-800 bg-zinc-950/45 p-6">
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <FormInput value={form.githubAppSlug} onChange={(event) => setForm({ ...form, githubAppSlug: event.target.value })} placeholder="northship" />
            </div>
