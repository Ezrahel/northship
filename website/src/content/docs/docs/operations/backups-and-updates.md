...
description: Keep database backups, host maintenance, and Northship updates visible.
sidebar:
  order: 3
---
...
Treat the dashboard and the host logs as a pair: the dashboard shows what Northship believes is happening, and the host logs show what the server is doing underneath.
