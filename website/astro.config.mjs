...
export default defineConfig({
  integrations: [
    starlight({
      title: "Northship Docs",
      description:
        "Documentation for installing and running Northship, a self-hosted deployment control plane for apps and databases.",
      favicon: "/favicon.svg",
      head: [
        { tag: "meta", attrs: { property: "og:image", content: socialImage } },
        { tag: "meta", attrs: { property: "og:image:alt", content: "Northship docs preview" } },
        { tag: "meta", attrs: { name: "twitter:image", content: socialImage } },
        { tag: "meta", attrs: { name: "twitter:image:alt", content: "Northship docs preview" } },
      ],
      ...
      social: [
        {
          icon: "github",
          label: "GitHub",
          href: "https://github.com/ezrahel/northship",
        },
      ],
      sidebar: [
        {
        ...
        },
        {
          ...
          items: [
            ...
            "docs/migration/northship-bundles",
          ],
        },
        {
          label: "Databases",
